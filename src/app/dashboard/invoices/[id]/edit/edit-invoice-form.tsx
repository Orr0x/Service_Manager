...
export function EditInvoiceForm({ id }: { id: string }) {
    ...
    useEffect(() => {
        if (invoice) {
            ...
            const parsedItems = (typeof invoice.items === 'string' ? JSON.parse(invoice.items) : invoice.items) as InvoiceItem[]
            setItems(parsedItems.length > 0 ? parsedItems : [{ description: '', quantity: 1, unitPrice: 0, total: 0 }])
        }
    }, [invoice])
            ...
            <form action={onSubmit} className="mt-8 space-y-8">
                        ...
                        <div className="flex">
                            <div className="ml-3">
                                <h3 className="text-sm font-medium text-red-800">
                                    Error updating invoice: {updateInvoice.error.message}
                                </h3>
                            </div>
                        </div>
                    </div>
                ...
                <div className="space-y-6">
                    <div className="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-6">
                        ...
                        <div className="sm:col-span-3">
                            ...
                            <div className="mt-2">
                                <select
                                    ...
                                    defaultValue={invoice.job_site_id || ''}
                        ...
                        <div className="sm:col-span-3">
                            <label htmlFor="customerAddress" className="block text-sm font-medium leading-6 text-gray-900">
                                Bill To Address (Customer)
                            </label>
                            <div className="mt-2">
                                <textarea
                                    id="customerAddress"
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <div className="mt-2">
                                <input
                                    ...
                                    id="dueDate"
                                    required
                                    defaultValue={new Date(invoice.due_date).toISOString().split('T')[0]}
                                    className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"
                                />
                            </div>
                        </div>
