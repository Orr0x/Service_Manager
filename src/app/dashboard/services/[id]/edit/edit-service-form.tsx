...
export function EditServiceForm({ service }: { service: any }) {
    ...
    // Check if initial category is "Other" (not in standard list)
    useEffect(() => {
        if (service.category && !categories.includes(service.category) && service.category !== 'Other') {
    ...
    async function onSubmit(formData: FormData) {
        ...
        try {
            ...
            updateService.mutate({
                ...
                imageUrl,
                unitOfMeasure,
                isActive: true // Default to keeping active on edit
            })
        } catch (error: any) {
        ...
        <form action={onSubmit} className="mt-8 space-y-6">
                    ...
                    <div className="flex">
                        <div className="ml-3">
                            <h3 className="text-sm font-medium text-red-800">
                                Error updating service: {updateService.error.message}
                            </h3>
                        </div>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div className="sm:col-span-3">
                    ...
                    <div className="mt-2">
                        <select
                            id="unitOfMeasure"
                            name="unitOfMeasure"
                            defaultValue={service.unit_of_measure}
                            className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6"
                        >
                ...
                <div className="col-span-full">
                    ...
                    <div className="mt-2">
                        <textarea
                            ...
                            defaultValue={service.coverage_area}
                            className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                        />
                    </div>
                </div>
                ...
                <div className="col-span-full">
                    ...
                    {service.image_url && (
                        <div className="mb-4">
                            <img src={service.image_url} alt="Current Service" className="h-32 w-auto rounded-lg object-cover" />
            ...
            <div className="flex items-center justify-end gap-x-6">
                ...
                >
                    {updateService.isPending || isUploading ? 'Saving...' : 'Save'}
                </button>
            </div>
        </form>
    )
